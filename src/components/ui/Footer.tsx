  ...
  return (
    <footer className="bg-black border-t border-white/10 py-12 md:py-20">
      <div className="container mx-auto px-6">
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0 text-white/40 text-xs tracking-widest uppercase">
          <p>© {currentYear} CHELO STUDIO. TODOS LOS DERECHOS RESERVADOS.</p>
          <p>DISEÑADO POR AGENCIA</p>
        </div>
      </div>
    </footer>
  );
